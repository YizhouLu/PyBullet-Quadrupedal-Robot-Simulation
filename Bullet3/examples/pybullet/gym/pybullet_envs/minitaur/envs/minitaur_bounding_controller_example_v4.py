...
for _ in range(1):
    ...
    from pybullet_envs.minitaur.envs import minitaur_bounding_controller_v4 as minitaur_bounding_controller
    ...
    # MINITAUR
    for _ in range(1):
        mat1 = sio.loadmat('vel_02_InitialCondition_to_VS_0006.mat')
        sorted(mat1.keys())
        ...
        """
        INIT_ORIENTATION = (0.029729672113599396, 0.10550833126287049, -0.14227961363486683, 0.9837381003976898)
        INIT_VELOCITY = (0.00698911, -0.03560622, -1.16232883)
        INIT_ANGULAR_VELOCITY = (0.3723568, 1.92046265, -0.01708326)
        """
        """
...
def main(argv):
    ...
    try:
        ...
        for i in num_iter:
            ...
            speed, aspeed = controller.get_speed(i)
            ...
            action, action_dot = controller.get_action(front_time, front_leg_pose, front_motor_velocity, back_time, back_leg_pose, back_motor_velocity, speed)
            ...
            # print('back desire exten = ', (action[3]+action[2])/2)g
            #input('-------------Pause-------------')
            """
            ...
            """
            desired_speed.append(speed)
            actual_speed.append(aspeed)
        """
        plt.figure(1)
        plt.subplot(2,1,1)
        ...
        """
        plt.figure(3)
        plt.plot(num_iter, desired_speed, num_iter, actual_speed)
